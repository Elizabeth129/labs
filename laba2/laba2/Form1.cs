    ...
    public partial class Form1 : Form
    {
        ...
        private void DeleteColumn_Click(object sender, EventArgs e)
        {
           // dataGridView.Columns.RemoveAt(1);
            try
            {
                DialogResult dialogResult = MessageBox.Show("Данные будут удалены", "Delete Column", MessageBoxButtons.YesNo);
        ...
        private void RowDel(DataGridView dataGrid)
        {
            try
            {
                DialogResult dialogResult = MessageBox.Show("Данные будут удалены", "Delete Row", MessageBoxButtons.YesNo);
                if (dialogResult == DialogResult.Yes)
                {
        ...
        {
            MessageBox.Show("Варіант 13:\n1)+,-,*,/(бінарні операції) \n5)inc,dec \n6)max(x,y),min(x,y) \n7)mmax(x1,x1...xN),mmin(x1,x2....xN)(N>=1)", "Info");
        }

        private void Form1_FormClosing(object sender, FormClosingEventArgs e)
        {
            DialogResult dialogResult = MessageBox.Show("Данные будут удалены", "Close file", MessageBoxButtons.YesNo);
            if (dialogResult == DialogResult.Yes)
            {
